"""RDT HDF5 loader with RoboTwin/XPolicyLab episode support.

Based on RoboticsDiffusionTransformer (MIT) and modified by the XPolicyLab
integration and rdt-robotwin-lab.
"""
...
from policy.xpolicylab.utils.process_data import decode_image_bit
...
class HDF5VLADataset:
    ...
    def parse_hdf5_file(self, file_path):
        ...
        with h5py.File(file_path, 'r') as f:
            ...
            # Each episode resolves to its own instruction or embedding.
    ...
    def _lang_embed_path(self, file_path):
        ...
        dataset_key = os.path.basename(
            os.path.normpath(self.HDF5_DIR)
        )
