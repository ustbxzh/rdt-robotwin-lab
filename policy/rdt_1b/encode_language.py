"""Encode one language condition per RoboTwin episode.

Based on the MIT-licensed RDT implementation vendored by XPolicyLab and
modified by rdt-robotwin-lab for episode-level alignment.
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Pre-encode one language embedding per RoboTwin episode."
    )
