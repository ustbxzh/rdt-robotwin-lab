"""Curated RoboTwin base environment.

RoboTwin MIT source, modified by rdt-robotwin-lab for external assets and
third-view evaluation video support.
"""
...
class Base_Task(gym.Env):
    ...
    def get_cluttered_table(self, cluttered_numbers=10, xlim=[-0.59, 0.59], ylim=[-0.34, 0.34], zlim=[0.741]):
        from .utils.rand_create_cluttered_actor import (
